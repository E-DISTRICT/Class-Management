...
export default function ClassDashboard({ onSelectClass }) {
    ...
    const fetchClasses = async () => {
        try {
        const response = await fetch(`http://localhost:3000/api/v1/classes/instructor/${instructorId}`);
    ...
    e.preventDefault();
    try {
        const response = await fetch('http://localhost:3000/api/v1/classes/createClass', {
        method: 'POST',
