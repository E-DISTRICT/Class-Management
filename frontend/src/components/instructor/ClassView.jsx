...
try {
    const res = await fetch(`https://class-management-backend-uoxs.onrender.com/api/v1/classes/students/${selectedClass._id}`);
...
const fetchAssignments = async () => {
  ...
  try {
    const response = await fetch(
      `https://class-management-backend-uoxs.onrender.com/api/v1/assignment/getAllAssignments/${selectedClass._id}`,
      {
        method: 'GET',
        headers: {
...
try {
const response = await fetch('https://class-management-backend-uoxs.onrender.com/api/v1/assignment/createAssignment', {
    method: 'POST',
...
const token = localStorage.getItem('token');
try {
    const response = await fetch(`https://class-management-backend-uoxs.onrender.com/api/v1/assignment/updateAssignment/${editingId}`, {
    method: 'PATCH',
...
const token = localStorage.getItem('token');
    ...
    try {
    const response = await fetch(`https://class-management-backend-uoxs.onrender.com/api/v1/assignment/deleteAssignment/${id}`, {
        method: 'DELETE',
        headers: {
        Authorization: `Bearer ${token}`,
        },
